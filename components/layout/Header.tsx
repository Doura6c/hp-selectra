...
const NAV_ITEMS = [
  {
    ...
    href: "/telecom/",
    sub: [
      { label: "Comparer les forfaits", href: "/telecom/comparateur/" },
      { label: "Meilleur forfait mobile", href: "/telecom/meilleur-forfait-mobile/" },
      { label: "Tous les opérateurs", href: "/telecom/fournisseurs/" },
    ],
  },
  {
    label: "Mobile Money",
    href: "/mobile-money/",
    sub: [
      { label: "Comparer les frais", href: "/mobile-money/comparateur/" },
      { label: "Meilleur transfert", href: "/mobile-money/meilleur-transfert-argent/" },
    ...
    >
      <div className="container">
        <div className="flex items-center justify-between h-16">
          {/* Logo — navigue vers / ET scrolle toujours en haut */}
          <Link
            href="/"
            ...
            {NAV_ITEMS.map((item) => (
              <div key={item.href}>
                <Link
                  ...
                  className="flex items-center justify-between px-3 py-3 rounded-lg text-sm font-medium text-white/90 hover:text-white hover:bg-white/10 transition-colors"
                >
